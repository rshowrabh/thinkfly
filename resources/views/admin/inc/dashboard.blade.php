                ...
                <div class="table-responsive">
                    <table class="table table-hover table-center">
                        ...
                        <tbody>
                            {{-- @for (var i == 1  ) --}}
                            <tr>
                                <td class="text-nowrap">Garrett Winters</td>
                                <td class="text-nowrap">Accountant</td>
                                <td class="text-nowrap">Tokyo</td>
                                <td class="text-nowrap">63</td>
                                <td class="text-nowrap">2011/07/25</td>
                                <td class="text-nowrap">$170,750</td>

                    ...
                    <div class="swiper-slide p-relative">
                        <div class="project-three__single">
                            <ul class="slider_hover__item">
                                {{-- @for($i=1; $i<=3; $i++) --}}
                                @foreach ($our_countries as $our_country)
                                
                                <li>
                                    <div class="project-three__single-inner wow fadeInLeft animated" data-wow-delay=".2s">
                                        <div class="project-small-img">
                                            <img src="{{asset('storage/'. $our_country->flag)}}" alt="img not found">
                                        </div>
                                        <div class="project-three__single-img" style="background-image: url({{asset('storage/'. $our_country->image)}});">
                                        </div>
                                        <div class="bg-overlay"></div>

                                        <div class="project-three__single-content">
                                            <h4>{{$our_country->category}}</h4>
                                            <p>{{$our_country->sub_text}}</p>

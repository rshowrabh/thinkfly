            ...
            <div class="col-lg-6">
                <div class="visa__item visa__item-2 mb-30 d-flex align-items-center wow fadeInLeft animated" data-wow-delay=".2s">
                    <div class="visa__item-media">
                        <img src="{{asset('storage/'. $visa->image)}}" alt="img not found">
                    </div>
                    <div class="visa__item-content">
                        <h5>{{$visa->category}}</h5>
                        <p>{{$visa->sub_text}}</p>
                        <div class="visa__item-content-button mt-30 d-flex justify-content-between">
                            <a href="visa/{{$visa->slug}}"><i class="fa-solid fa-arrow-right"></i></a>
                            <img src="{{asset('storage/'. $visa->icon)}}" alt="img not found">
                        </div>
                    </div>
                </div>
            </div>
